...
// ../.wrangler/tmp/bundle-jh5y0w/strip-cf-connecting-ip-header.js
...
var onRequestGet = /* @__PURE__ */ __name(async (ctx) => {
  ...
  const deny = /* @__PURE__ */ __name((msg, status) => new Response(msg, { status }), "deny");
...
// ../.wrangler/tmp/pages-OuQRgS/functionsRoutes-0.3865654694768833.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-jh5y0w/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-jh5y0w/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.24731872529510923.mjs.map
